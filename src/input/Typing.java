...
public class Typing implements KeyListener
{
	...
	public void keyPressed(KeyEvent e)
	{
		...
		if(inChat)
		{
			...
			{
				String[] splited = chat.split("\\s+");
				if(splited[0].equals("/tp"))
				{
					Handler.cam.setPlayer(Integer.parseInt(splited[1]) * Maps.tileScale, Integer.parseInt(splited[2]) * Maps.tileScale);
				}
				if(!chat.equals(""));
				{
