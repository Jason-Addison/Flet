    ...
    public void draw(Graphics2D g, int x, int y, BasicLight light)
    {
        do
        {
           ...
           // g.setComposite(AlphaComposite.getInstance(AlphaComposite.SRC_OVER, 1f));
            g.setComposite(AlphaComposite.getInstance(AlphaComposite.SRC_OVER, 0.97f)); // the amount of color we want from the light map to be composited into the scene 
