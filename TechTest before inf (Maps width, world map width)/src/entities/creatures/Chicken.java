...
public class Chicken extends Entity
{
	...
	double speed = 0.5;
	public static double MAX_SPEED = 1.16666666667;
	Point2D.Double offsetToDest = new Point2D.Double(0, 0);
	public Chicken()
	{
		super(Sources.MOB_CHICKEN[0][0], new Rectangle2D.Double(0, 0, 100, 100), 3);
		double random = Handler.util.randomNumber(70, 50);
		speed = random / 60;
	}
	Point2D.Double currentDestination = new Point2D.Double(0, 0);
	public void roam()
	{
		//if(!inMotion)
		{
